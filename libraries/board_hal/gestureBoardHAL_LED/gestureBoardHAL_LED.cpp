...
GestureBoardHalLed::GestureBoardHalLed(Animation *defaultAnim)
    : _runningAnimation(defaultAnim) {
  this->_count = 0;
...
uint16_t GestureBoardHalLed::getMapping() { return this->_map.mappingLed_byte; }
...
Animation *GestureBoardHalLed::tabAnimations[] = {
    new SwipeLeft(),  new SwipeRight(), new FiveButtons(),   new ThreeButtons(),
    new TwoButtons(), new OneButton(),  new SleepModePulse()};
