...
GestureBoardHalLed_V1_1::GestureBoardHalLed_V1_1(Animation *defaultAnim,
                                                 int delay)
    : GestureBoardHalLed(defaultAnim) {
...
void GestureBoardHalLed_V1_1::blinker(int delayBlinker) {
  this->dim(0);
  delay(delayBlinker);
  this->dim(255);
  delay(delayBlinker);
